// $Id: TransientStructuralSolution.C,v 1.1.2.1 2007-09-06 07:14:15 manav Exp $
...
Solution::TransientStructuralSolution::TransientStructuralSolution():
Solution::SolutionBase(Solution::TRANSIENT_STRUCTURAL_SOLUTION::num())
{
...
unsigned int 
Solution::TransientStructuralSolution::getDisciplineTransientNatureEnumID
...
void
Solution::TransientStructuralSolution::solve()
{
  ...
  switch (info.getAnalysisTypeEnumID())
    ...
    case LINEAR_ANALYSIS_ENUM_ID:
      this->linearTransientSolve(Discipline::STRUCTURAL_DISCIPLINE::num());
      break;
...
std::istream&
Solution::TransientStructuralSolution::readFromInputStream(std::istream& input)
{
  std::string tag;
  unsigned int num = 0;
...
Solution::TransientStructuralSolution::getTimeIndependentNodalSolutionDataInfo
...
Solution::TransientStructuralSolution::getTimeDependentNodalSolutionDataInfo
(const unsigned int discipline_enum_ID)
{
