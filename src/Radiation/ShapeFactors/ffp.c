/* $Id: ffp.c,v 1.6 2006-09-05 20:46:33 manav Exp $ */

static	char	rcs_id[] = "$Header: /Users/manav/Documents/codes/CVS_ROOT/FESystem/src/Radiation/ShapeFactors/ffp.c,v 1.6 2006-09-05 20:46:33 manav Exp $";
	    ...
	    real *factor12, real *factor21)
{
  ...
  *factor12 = ff / ( ( ( real )( M_PIF * 8 ) ) * Area( p, np ) );
  *factor21 = ff / ( ( ( real )( M_PIF * 8 ) ) * Area( q, nq ) );
}
