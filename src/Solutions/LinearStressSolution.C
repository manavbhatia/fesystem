...
Solution::LinearStressSolution::LinearStressSolution():
Solution::SolutionBase(Solution::LINEAR_STRESS_SOLUTION::num()),
...
unsigned int 
Solution::LinearStressSolution::getDisciplineTransientNatureEnumID(const unsigned int discipline) const 
{
...
void
Solution::LinearStressSolution::solve()
{
...
std::istream&
Solution::LinearStressSolution::readFromInputStream(std::istream& input)
{
  std::string tag;
  unsigned int num = 0;
...
Solution::LinearStressSolution::getTimeIndependentNodalSolutionDataInfo
...
Solution::LinearStressSolution::getTimeDependentNodalSolutionDataInfo
(const unsigned int discipline_enum_ID)
{
  // unused parameter
