// $Id: FluidElem.h,v 1.1.2.1 2008-02-25 04:25:45 manav Exp $

#ifndef __fesystem_fluid_elem_h__
#define __fesystem_fluid_elem_h__
...
#ifndef FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_ID
#define FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_ID 1
#else
#error
#endif

#ifndef FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_NAME
#define FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_NAME "FLUID_INVISCID_JACOBIAN_MATRIX"
#else
#error
#endif


#ifndef FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_ID
#define FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_ID 2
#else
#error
#endif

#ifndef FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_NAME
#define FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_NAME "FLUID_VISCOUS_JACOBIAN_MATRIX"
#else
#error
#endif


#ifndef FLUID_F_VECTOR_ENUM_ID
#define FLUID_F_VECTOR_ENUM_ID 3
#else
#error
#endif

#ifndef FLUID_F_VECTOR_ENUM_NAME
#define FLUID_F_VECTOR_ENUM_NAME "FLUID_F_VECTOR"
#else
#error
#endif
...
namespace FESystemElem
{
  ...
  DeclareEnumClass(FluidElemQtyEnum);
  
  DeclareEnumName(FLUID_INVISCID_JACOBIAN_MATRIX, FESystemElem::FluidElemQtyEnum,
                  FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_ID, FLUID_INVISCID_JACOBIAN_MATRIX_ENUM_NAME);

  DeclareEnumName(FLUID_VISCOUS_JACOBIAN_MATRIX, FESystemElem::FluidElemQtyEnum,
                  FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_ID, FLUID_VISCOUS_JACOBIAN_MATRIX_ENUM_NAME);
  
  DeclareEnumName(FLUID_F_VECTOR, FESystemElem::FluidElemQtyEnum,
                  FLUID_F_VECTOR_ENUM_ID, FLUID_F_VECTOR_ENUM_NAME);
  
  /**
    *	a base class defining the heat conduction elements
   */
  
  class FluidElem: public FESystemElem::FESystemElemBase
    {
public:
      /// constructor
      FluidElem(const unsigned int dim, 
...
protected:
      ...
      template <class QtyType >
        void getFluidElemQty(const unsigned int name,
                               QtyType* qty,
                               const unsigned int design_point_enum_ID,
      ...
      void calculateFluidElemQty(DenseVector<double>* qty, 
                                   const unsigned int qty_enum_ID, 
                                   const unsigned int design_point_enum_ID,
      ...
      /// quantities. It calls the method that performs the calculations and returns the
      /// quantity in the first arguement. 
      void calculateFluidElemQty(DenseMatrix<double>* qty, 
                                   const unsigned int qty_enum_ID, 
                                   const unsigned int design_point_enum_ID,
                                   const unsigned int domain_enum_ID);
       ...
       */
      virtual void calculateInviscidJacobian(DenseMatrix<double>* matrix, 
                                             const unsigned int design_point_enum_ID,
                                             bool sensitivity_calculation);
      
      virtual void calculateViscousJacobian(DenseMatrix<double>* matrix, 
                                            const unsigned int design_point_enum_ID,
                                            bool sensitivity_calculation);
      /**
...
inline
unsigned int FESystemElem::FluidElem::getTransientSystemOrder() const
{
  return 1;
}
...
inline
void 
FESystemElem::FluidElem::getElementAssembledQty(const unsigned int name_enum_ID,
                                                  DenseVector<double>* qty)
{
...
inline
void
FESystemElem::FluidElem::getElementAssembledQtySensitivity(const unsigned int name_enum_ID,
                                                             DenseVector<double>* qty)
{
  assert (qty != NULL);
  qty->zero();
...
//template <class QtyType >
//void 
//FESystemElem::FluidElem::getFluidElemQty(const unsigned int name,
//                                             QtyType* qty,
//                                             const unsigned int design_point_enum_ID,
//                                             const unsigned int domain,
//                                             const bool sensitivity)
...
//  
//  if (!sensitivity)
//    this->calculateFluidElemQty(qty, name, design_point_enum_ID, domain);
//  else
//    {
...
//    this->calculateFluidElemQty(qty, name,
...
//    base_qty.zero();
//    this->getFluidElemQty(name, &base_qty,  FESystemElem::BASE_ELEM::num(), domain, false);
//    
...
#endif // __fesystem_fluid_elem_h__
